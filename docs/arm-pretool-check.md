...
- `--command <exact string>` for Pi, pi-signed, and omp.
...
## Historical validation record, 2026-07-09

The OpenCode observations below predate its removal and do not describe a supported adapter.
