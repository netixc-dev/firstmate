...
It is not deterministic across the verified adapters: codex, grok, and gemini resume only from a session id printed at exit, claude, pi, pi-signed, omp, and kimi have no verified pane-resume contract.
