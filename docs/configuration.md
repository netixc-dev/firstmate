...
The retired `agy` and Devin CLI worker adapters are unsupported: explicit harness selections, static pins, dispatch profiles, and legacy task records naming either are refused before task mutation rather than falling back to another runtime.
