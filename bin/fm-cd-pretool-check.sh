...
#
# Stdin mode extracts .tool_input.command for Claude, Codex, and Cursor. CLI mode is used by OpenCode and Pi after their
...
With no --command, reads a PreToolUse-style JSON payload on stdin (Claude/Codex tool_input.command).
