...
If static `config/crew-harness` or `config/secondmate-harness` names an unverified adapter, refuse dispatch and report the pin rather than substituting another runtime.
