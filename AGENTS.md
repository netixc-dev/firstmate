...
The verified harnesses are `claude`, `codex`, `opencode`, `pi`, `pi-signed`, `kimi`, `cursor`, and `omp`, plus `gemini` for crewmates and scouts only; never dispatch on an unverified adapter.
