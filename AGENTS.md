...
The verified harnesses are `claude`, `codex`, `pi`, `pi-signed`, `grok`, `kimi`, `cursor`, and `omp`, plus `gemini` for crewmates and scouts only; never dispatch on an unverified adapter.
